...
{
    public class FilteredNotificationSender
    {
        static string token = "68814003c9d184056341533f627c261d6017b1b5";

        public static async void sendNotification(string title, string content, string userPusheId)
        {
            ...
            var response = await client.PostAsync(
                ...
                getNotificationData(title, content, userPusheId)
            );
        ...
        public static StringContent getNotificationData(string title, string content, string userPusheId)
        {
            ...
            request_data.Add("filters", filter);
